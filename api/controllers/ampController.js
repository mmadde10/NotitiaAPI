...
exports.list_all_amp_documents = function(req, res){
    res.send('NOT IMPLEMENTED:list_all_amp_documents');
};
//CRUD AMP DOCUMENT
exports.create_amp_document = function(req, res){
    var ampInputObject = ampHelper.manageInputData(req);
    res.send('NOT IMPLEMENTED:create_amp_document');
};
exports.read_amp_document = function(req, res){
    res.send('NOT IMPLEMENTED:list_all_amp_documents');
}
exports.update_amp_document = function(req, res){
    res.send('NOT IMPLEMENTED:update_amp_document');
}
exports.delete_amp_document = function(req, res){
    res.send('NOT IMPLEMENTED:delte_amp_document');
} 

//AMP HEADS
exports.list_all_amp_heads = function(req, res){
    res.send('NOT IMPLEMENTED:list_all_amp_heads');
}
//CRUD HEADS
exports.create_amp_heads = function(req, res){
    res.send('NOT IMPLEMENTED:create_amp_heads');
}
exports.read_amp_head = function(req, res){
    res.send('NOT IMPLEMENTED:read_amp_head');
}
exports.update_amp_head = function(req, res){
    res.send('NOT IMPLEMENTED:update_amp_head');
}
exports.delete_amp_head = function(req, res){
    res.send('NOT IMPLEMENTED:delete_amp_head');
}

//AMP Bodies
exports.list_all_amp_body = function(req, res){
    res.send('NOT IMPLEMENTED:list_all_amp_body');
}
//CRUD BODY
